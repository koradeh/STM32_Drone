...
/* User Configuration */
// Timer Clock
#define TIMER_CLOCK				137500000	// 137.5MHz

// MOTOR 1 (PA5) - TIM2 Channel 1, DMA1 Stream 0
#define MOTOR_1_TIM             (&htim2)
#define MOTOR_1_TIM_CHANNEL     TIM_CHANNEL_1

// MOTOR 2 (PA7) - TIM3 Channe2 , DMA1 Stream 2
...
// MOTOR 4 (PB1) - TIM3 Channel 4, DMA1 Stream 3
...
#define DSHOT600_HZ     		MHZ_TO_HZ(6)
#define DSHOT300_HZ     		MHZ_TO_HZ(3)
#define DSHOT150_HZ     		MHZ_TO_HZ(1.5)
